    ...
    <GameContext.Provider value={{ state, dispatch }}>
      <div className="container mx-auto mt-5 p-4 bg-[#3A1E10] rounded-lg shadow-lg">
        ...
        <div className="text-center mb-4">
          <h2 className="text-lg font-bold text-white">{mode === 'one-player' ? "Player A vs Computer" : "Player A vs Player B"}</h2>
          <h3 className="text-lg font-bold text-white">Current Turn: {currentTurn}</h3>
        </div>
        {winMessage && (
